...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'سیستم رزرواسیون چندمنظوره برای هر نوع کسب‌وکاری. افزایش 40% درآمد با مدیریت هوشمند رزروها.',
